  ...
  <div class="card">
    <div class="card-header">
      <div class="row justify-content-between">
        <h4 class="card-title col-10">Edit Administrator</h4>
        <a href="/admin/users/administrators" class="col-2 btn btn-secondary">
          <i class="fa-solid fa-arrow-left"></i> Back to Administrators
        </a>
      </div>
    </div>
    <div class="card-body">
      <form action="/admin/users/administrators/{{ $user->user_username }}" method="POST" enctype="multipart/form-data">
        @method('PUT')
        @csrf
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="form-group">
              <label for="user_image" class="form-label">Administrator Profile</label>
