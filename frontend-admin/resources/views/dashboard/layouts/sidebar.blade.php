    ...
    <div class="sidebar-menu">
      <ul class="menu">
        ...
        <li class="sidebar-item {{ (Request::is('admin/materies*') || Request::is('admin/my-materies*')) ? 'active' : '' }} has-sub">
          ...
          <ul class="submenu">
            <li class="submenu-item {{ Request::is('admin/materies/create') ? 'active' : '' }}">
              <a href="/admin/materies/create" class="submenu-link"
                >Add Matery</a>
            </li>
        ...
        <li class="sidebar-item {{ (Request::is('admin/users*')) ? 'active' : '' }} has-sub">
          <a href="#" class="sidebar-link">
            <i class="fa-solid fa-newspaper"></i>
            <span>Users</span>
          </a>
