...
class TeacherController extends Controller
{
    ...
    public function index()
    {
        ...
        $response = Http::withHeaders([
            'Accept' => 'application/json',
            'Authorization' => 'Bearer ' . $_COOKIE['my_token'],
        ])->get(env('SERVER_API') . 'users/teacher');

        $data = [
            "title" => "Teachers",
            "user" => $user->data,
            "teachers" => json_decode($response)->data,
        ];
    ...
    public function create() {
        ...
        return view('dashboard.teachers.create', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/admin/users/teachers')->with('success', 'New teacher has been added!');
    }
    ...
    public function edit(String $parameter)
    {
        ...
        return view('dashboard.teachers.edit', $data);
    }
    ...
    public function update(Request $request, String $parameter)
    {
        ...
        return redirect('/admin/users/teachers')->with('success', 'Teacher has been updated!');
    }
